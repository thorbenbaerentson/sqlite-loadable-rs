...
pub unsafe fn faux_sqlite_extension_init2(api: *mut sqlite3_api_routines) { unsafe {
    if !api.is_null() {
        SQLITE3_API = api;
    }
}}
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_text(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_uchar { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_type(value: *mut sqlite3_value) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_subtype(value: *mut sqlite3_value) -> u32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_bytes(arg1: *mut sqlite3_value) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_blob(arg1: *mut sqlite3_value) -> *const c_void { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_step(stmt: *mut sqlite3_stmt) -> c_int { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_finalize(stmt: *mut sqlite3_stmt) -> c_int { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_column_text(stmt: *mut sqlite3_stmt, c: c_int) -> *const c_uchar { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_column_int64(stmt: *mut sqlite3_stmt, c: c_int) -> i64 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_column_bytes(stmt: *mut sqlite3_stmt, c: c_int) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_column_value(stmt: *mut sqlite3_stmt, c: c_int) -> *mut sqlite3_value { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_bind_int(stmt: *mut sqlite3_stmt, c: c_int, v: c_int) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_bind_int64(stmt: *mut sqlite3_stmt, c: c_int, v: i64) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_int(arg1: *mut sqlite3_value) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_int64(arg1: *mut sqlite3_value) -> i64 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_double(arg1: *mut sqlite3_value) -> f64 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_value_pointer(arg1: *mut sqlite3_value, p: *mut c_char) -> *mut c_void { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_int(context: *mut sqlite3_context, v: c_int) { unsafe {
    if false {
    } else {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_blob(context: *mut sqlite3_context, p: *const c_void, n: i32) { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_int64(context: *mut sqlite3_context, v: i64) { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_double(context: *mut sqlite3_context, f: f64) { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_null(context: *mut sqlite3_context) { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_error(context: *mut sqlite3_context, s: *const c_char, n: i32) { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_error_code(context: *mut sqlite3_context, code: i32) { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_result_subtype(context: *mut sqlite3_context, subtype: u32) { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_get_auxdata(context: *mut sqlite3_context, n: c_int) -> *mut c_void { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_vtab_distinct(index_info: *mut sqlite3_index_info) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_declare_vtab(db: *mut sqlite3, s: *const c_char) -> i32 { unsafe {
    #[cfg(not(feature = "static"))]
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_overload_function(db: *mut sqlite3, s: *const c_char, n: i32) -> i32 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_context_db_handle(context: *mut sqlite3_context) -> *mut sqlite3 { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_user_data(context: *mut sqlite3_context) -> *mut c_void { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_mprintf(s: *const c_char) -> *mut c_char { unsafe {
...
#[cfg(not(feature = "static"))]
pub unsafe fn sqlite3ext_auto_extension(f: unsafe extern "C" fn()) -> i32 { unsafe {
